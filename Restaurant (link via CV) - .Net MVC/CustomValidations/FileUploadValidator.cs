...
namespace NepaleseRestaurant.CustomValidations
{
        ...
        : ValidationAttribute, IClientValidatable
    {
            ...
            , ControllerContext context)
        {
            ...
            clientValidationRule.ValidationParameters.Add("clientvalidationmethods", clientvalidationmethods.ToString());
            clientValidationRule.ValidationParameters.Add("parameters", parameters.ToString());
            clientValidationRule.ValidationParameters.Add("errormessages", errorMessages.ToString());
